...
async function loadActiveChats() {
    try {
        ...
        const response = await fetch(`${API_BASE || 'https://instagrowthpro-backend.onrender.com'}/api/chat/active-chats');
...
async function selectChat(userId, username) {
    ...
    // Mark as read
    await fetch(`${API_BASE || 'https://instagrowthpro-backend.onrender.com'}/api/chat/mark-read', {
        method: 'POST',
...
async function loadMessages() {
    ...
    try {
        const response = await fetch(`${API_BASE || 'https://instagrowthpro-backend.onrender.com'}/api/chat/${selectedUserId}`);
...
async function sendMessage() {
    ...
    try {
        await fetch(`${API_BASE || 'https://instagrowthpro-backend.onrender.com'}/api/chat/send', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
